            ...
            if (m_Active)
            {
                ...
                if (m_State == State.MovingForward)
                {
                    ...
                    else
                    {
                        ...
                        // Move bricks.
                        var delta = transform.forward * Mathf.Min(m_Distance, m_Distance / m_Time * m_CurrentTime) * LEGOHorizontalModule - m_Offset;
                ...
                if (m_State == State.MovingBack)
                {
                    ...
                    else
                    {
                        ...
                        // Move bricks.
                        var delta = transform.forward * Mathf.Max(0, m_Distance - m_Distance / m_Time * m_CurrentTime) * LEGOHorizontalModule - m_Offset;
                        foreach (var brick in m_ScopedBricks)
                        {
                            brick.transform.position += delta;
                        }
